...
public final class DNIn {
    ...
    public static char readChar() {
        try {
            ...
            assert ch.length() == 1 : "Internal (DN)In.readChar() error!"
     ...
     * @throws NoSuchElementException if standard input is empty
     * @throws InputMismatchException if the next token cannot be parsed
     *                                as a {@code true}, {@code 1}, {@code false} or
     *                                {@code 0}
     */
    ...
    // do this once when DNIn is initialized
    static {
        resync();
    }

    // If DNIn changes, use this to reinitialize the scanner.
    ...
    private static void setScanner(Scanner scanner) {
        DNIn.scanner = scanner;
        DNIn.scanner.useLocale(LOCALE);
    }
    ...
    public static void main(String[] args) {
        DNOut.print("Type a string: ");
        String s = DNIn.readString();
        DNOut.println("Your string was: " + s);
        DNOut.println();

        DNOut.print("Type an int: ");
        int a = DNIn.readInt();
        DNOut.println("Your int was: " + a);
        DNOut.println();

        DNOut.print("Type a boolean: ");
        boolean b = DNIn.readBoolean();
        DNOut.println("Your boolean was: " + b);
        DNOut.println();

        DNOut.print("Type a double: ");
        double c = DNIn.readDouble();
        DNOut.println("Your double was: " + c);
        DNOut.println();
    }
}
